...
"""Verify that starting icacoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start icacoin with -h for help text")
        ...
        self.log.info("Start icacoin with -version for version information")
