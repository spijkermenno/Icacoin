...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s icacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  icacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded icacoin transaction") + "\n" +
              "  icacoin-tx [options] -create [commands]   " + _("Create hex-encoded icacoin transaction") + "\n" +
              "\n";
