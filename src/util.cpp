...
const char * const BITCOIN_CONF_FILENAME = "icacoin.conf";
const char * const BITCOIN_PID_FILENAME = "icacoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Icacoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Icacoin";
#else
    // Unix
    return pathRet / ".icacoin";
#endif
#endif
}
