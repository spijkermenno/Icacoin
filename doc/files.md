...
* icacoin.conf: contains configuration settings for icacoind or icacoin-qt
* icacoind.pid: stores the process id of icacoind while running
...
* debug.log: contains debug information and general logging generated by icacoind or icacoin-qt
